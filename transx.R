transx <- function(x, tcode) {
    #    Transform x. Return Series with same dimension and corresponding dates. Missing values where not calculated
    #    -- Tcodes:
    #             1 Level
    #             2 First Difference
    #             3 Second Difference
    ...
    #  Translated from the Gauss procs of Stock&Watson(2005),'Implications of dynamic factor models for VAR analysis'
